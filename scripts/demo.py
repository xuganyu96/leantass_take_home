...
BLOCKS_PATH = './data/blocks_demo.csv'
CASES_PATH = './data/cases_demo.csv'
DB_PATH = './database/compilation_demo.db'
...
stats_output = open('./export/case_length_stats_demo.txt', 'w+')
